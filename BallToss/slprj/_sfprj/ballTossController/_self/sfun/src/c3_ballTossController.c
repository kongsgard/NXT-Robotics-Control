...
static const char * c3_debug_family_names[8] = { "nargin", "nargout", "traj_in",
  "dtraj_in", "t_ref", "t_in", "ref_cur", "dref_cur" };

/* Function Declarations */
static void initialize_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static void initialize_params_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static void enable_c3_ballTossController(SFc3_ballTossControllerInstanceStruct
  *chartInstance);
static void disable_c3_ballTossController(SFc3_ballTossControllerInstanceStruct *
  chartInstance);
static void c3_update_debugger_state_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static void set_sim_state_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_ballTossController(SFc3_ballTossControllerInstanceStruct
  *chartInstance);
static void sf_gateway_c3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static void initSimStructsc3_ballTossController
  (SFc3_ballTossControllerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c3_dref_cur, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_ballTossControllerInstanceStruct
...
static real_T c3_interp1(SFc3_ballTossControllerInstanceStruct *chartInstance,
  real_T c3_varargin_1[10], real_T c3_varargin_2[10], real_T c3_varargin_3);
static void c3_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_b_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_ballTossControllerInstanceStruct
  *chartInstance);
static void c3_c_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_d_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_StringToMethodID(SFc3_ballTossControllerInstanceStruct
  *chartInstance);
static void c3_e_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_f_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_g_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_h_assert(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_eml_error(SFc3_ballTossControllerInstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_ballTossController, const
  char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_ballTossControllerInstanceStruct
  *chartInstance);
  ...
  (SFc3_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_ballTossController = 0U;
}
  ...
  (SFc3_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T *c3_dref_cur;
  real_T *c3_ref_cur;
  c3_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(3, 1), false);
  c3_hoistedGlobal = *c3_dref_cur;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = *c3_ref_cur;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_ballTossController;
  ...
  (SFc3_ballTossControllerInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_dref_cur = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 0)), "dref_cur");
  *c3_ref_cur = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 1)), "ref_cur");
  chartInstance->c3_is_active_c3_ballTossController = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_ballTossController");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_ballTossController(chartInstance);
  ...
  (SFc3_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T c3_hoistedGlobal;
  int32_T c3_i3;
  real_T c3_traj_in[10];
  int32_T c3_i4;
  real_T c3_dtraj_in[10];
  int32_T c3_i5;
  real_T c3_t_ref[10];
  real_T c3_t_in;
  ...
  real_T c3_dref_cur;
  int32_T c3_i6;
  real_T c3_b_t_ref[10];
  int32_T c3_i7;
  real_T c3_b_traj_in[10];
  int32_T c3_i8;
  real_T c3_c_t_ref[10];
  int32_T c3_i9;
  real_T c3_b_dtraj_in[10];
  real_T *c3_b_ref_cur;
  real_T *c3_b_t_in;
  real_T *c3_b_dref_cur;
  real_T (*c3_d_t_ref)[10];
  real_T (*c3_c_dtraj_in)[10];
  real_T (*c3_c_traj_in)[10];
  c3_b_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_b_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c3_b_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_d_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 2);
  c3_c_dtraj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
  c3_c_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c3_sfEvent);
  for (c3_i0 = 0; c3_i0 < 10; c3_i0++) {
    _SFD_DATA_RANGE_CHECK((*c3_c_traj_in)[c3_i0], 0U);
  }

  for (c3_i1 = 0; c3_i1 < 10; c3_i1++) {
    _SFD_DATA_RANGE_CHECK((*c3_c_dtraj_in)[c3_i1], 1U);
  }

  for (c3_i2 = 0; c3_i2 < 10; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*c3_d_t_ref)[c3_i2], 2U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_t_in;
  for (c3_i3 = 0; c3_i3 < 10; c3_i3++) {
    c3_traj_in[c3_i3] = (*c3_c_traj_in)[c3_i3];
  }

  for (c3_i4 = 0; c3_i4 < 10; c3_i4++) {
    c3_dtraj_in[c3_i4] = (*c3_c_dtraj_in)[c3_i4];
  }

  for (c3_i5 = 0; c3_i5 < 10; c3_i5++) {
    c3_t_ref[c3_i5] = (*c3_d_t_ref)[c3_i5];
  }

  c3_t_in = c3_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_traj_in, 2U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_dtraj_in, 3U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_t_ref, 4U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_t_in, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_ref_cur, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_dref_cur, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 2);
  if (CV_EML_IF(0, 1, 0, c3_t_in < 0.0)) {
    ...
    if (CV_EML_IF(0, 1, 1, c3_t_in > c3_t_ref[9])) {
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 6);
      c3_ref_cur = c3_traj_in[9];
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 7);
      c3_dref_cur = c3_dtraj_in[9];
    } else {
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
      for (c3_i6 = 0; c3_i6 < 10; c3_i6++) {
        c3_b_t_ref[c3_i6] = c3_t_ref[c3_i6];
      }

      for (c3_i7 = 0; c3_i7 < 10; c3_i7++) {
        c3_b_traj_in[c3_i7] = c3_traj_in[c3_i7];
      }

      c3_ref_cur = c3_interp1(chartInstance, c3_b_t_ref, c3_b_traj_in, c3_t_in);
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 10);
      for (c3_i8 = 0; c3_i8 < 10; c3_i8++) {
        c3_c_t_ref[c3_i8] = c3_t_ref[c3_i8];
      }

      for (c3_i9 = 0; c3_i9 < 10; c3_i9++) {
        c3_b_dtraj_in[c3_i9] = c3_dtraj_in[c3_i9];
      }

      c3_dref_cur = c3_interp1(chartInstance, c3_c_t_ref, c3_b_dtraj_in, c3_t_in);
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -10);
  _SFD_SYMBOL_SCOPE_POP();
  *c3_b_ref_cur = c3_ref_cur;
  *c3_b_dref_cur = c3_dref_cur;
  ...
  _SFD_DATA_RANGE_CHECK(*c3_b_ref_cur, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_b_t_in, 4U);
  _SFD_DATA_RANGE_CHECK(*c3_b_dref_cur, 5U);
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc3_ballTossControllerInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_dref_cur, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_dref_cur),
    &c3_thisId);
  sf_mex_destroy(&c3_dref_cur);
  return c3_y;
}
...
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_dref_cur;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc3_ballTossControllerInstanceStruct *)chartInstanceVoid;
  c3_dref_cur = sf_mex_dup(c3_mxArrayInData);
  ...
  *c3_inData)
{
  ...
  for (c3_i10 = 0; c3_i10 < 10; c3_i10++) {
    c3_b_inData[c3_i10] = (*(real_T (*)[10])c3_inData)[c3_i10];
  }
...
const mxArray *sf_c3_ballTossController_get_eml_resolved_functions_info(void)
{
  const mxArray *c3_nameCaptureInfo = NULL;
  c3_nameCaptureInfo = NULL;
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 81, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("interp1"), "name", "name", 0);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1381882706U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("length"), "name", "name", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 15);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("strncmpi"), "name", "name", 15);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "resolved",
                  "resolved", 15);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1328890322U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 20);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("min"), "name", "name", 20);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("lower"), "name", "name", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/lower.m"), "context",
                  "context", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_string_transform"), "name",
                  "name", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("colon"), "name", "name", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 27);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1378328388U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("colon"), "name", "name", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("floor"), "name", "name", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmin"), "name", "name", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmax"), "name", "name", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "name", "name", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/char.m"), "resolved",
                  "resolved", 51);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1319762368U), "fileTimeLo",
                  "fileTimeLo", 51);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 51);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 52);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("coder.internal.nan"), "name",
                  "name", 52);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1362294432U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 55);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 55);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 58);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("flip"), "name", "name", 58);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 63);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("floor"), "name", "name", 63);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 63);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
...
static void c3_b_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmax"), "name", "name", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 67);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 67);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 67);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("coder.internal.bsearch"),
                  "name", "name", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363743358U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 71);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("floor"), "name", "name", 71);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 73);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmax"), "name", "name", 73);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 74);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 74);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 76);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 76);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 79);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 79);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  real_T c3_varargin_1[10], real_T c3_varargin_2[10], real_T c3_varargin_3)
{
  ...
  real_T c3_y2;
  int32_T exitg1;
  c3_assert(chartInstance);
  for (c3_i12 = 0; c3_i12 < 10; c3_i12++) {
    c3_y[c3_i12] = c3_varargin_2[c3_i12];
  }

  c3_xi = c3_varargin_3;
  for (c3_i13 = 0; c3_i13 < 10; c3_i13++) {
    c3_x[c3_i13] = c3_varargin_1[c3_i13];
  }

  c3_b_assert(chartInstance);
  c3_eml_scalar_eg(chartInstance);
  c3_c_assert(chartInstance);
  c3_d_assert(chartInstance);
  c3_StringToMethodID(chartInstance);
  c3_e_assert(chartInstance);
  c3_f_assert(chartInstance);
  c3_g_assert(chartInstance);
  c3_h_assert(chartInstance);
  c3_Vq = rtNaN;
  c3_k = 1;
  do {
    exitg1 = 0;
    if (c3_k < 11) {
      ...
      if (c3_x[1] < c3_x[0]) {
        for (c3_j1 = 1; c3_j1 < 6; c3_j1++) {
          c3_b_j1 = c3_j1;
          c3_xtmp = c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c3_b_j1), 1, 10, 1, 0) - 1];
          c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c3_b_j1), 1, 10, 1, 0) - 1] =
            c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c3_b_j1)), 1, 10, 1, 0) - 1];
          c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c3_b_j1)), 1, 10, 1, 0) - 1] = c3_xtmp;
        }

        for (c3_c_k = 1; c3_c_k < 6; c3_c_k++) {
          c3_d_k = c3_c_k;
          c3_tmp = c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c3_d_k), 1, 10, 1, 0) - 1];
          c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c3_d_k), 1, 10, 1, 0) - 1] =
            c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c3_d_k)), 1, 10, 1, 0) - 1];
          c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c3_d_k)), 1, 10, 1, 0) - 1] = c3_tmp;
        }
      }

      for (c3_e_k = 2; c3_e_k < 11; c3_e_k++) {
        c3_b_k = c3_e_k;
        if (c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c3_b_k), 1, 10, 1, 0) - 1] <=
            c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)(c3_b_k - 1)), 1, 10, 1, 0) - 1]) {
      ...
      if (c3_b_b) {
      } else if (c3_xik > c3_maxx) {
      } else if (c3_xik < c3_minx) {
      } else {
        c3_c_xi = c3_xik;
        c3_low_i = 1;
        c3_low_ip1 = 1;
        ...
        while (c3_high_i > c3_low_ip1 + 1) {
          ...
          if (c3_c_xi >= c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c3_mid_i), 1, 10, 1, 0) - 1]) {
            c3_low_i = c3_mid_i;
            c3_low_ip1 = c3_low_i;
          } else {
            c3_high_i = c3_mid_i;
        ...
        c3_n = c3_low_i;
        c3_xn = c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c3_n), 1, 10, 1, 0) - 1];
        c3_xnp1 = c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)(c3_n + 1)), 1, 10, 1, 0) - 1];
        c3_A = c3_xik - c3_xn;
        c3_B = c3_xnp1 - c3_xn;
        c3_d_x = c3_A;
        c3_b_y = c3_B;
        ...
        c3_r = c3_f_x / c3_d_y;
        c3_onemr = 1.0 - c3_r;
        c3_y1 = c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c3_n), 1, 10, 1, 0) - 1];
        c3_y2 = c3_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)(c3_n + 1)), 1, 10, 1, 0) - 1];
        if (c3_y1 == c3_y2) {
          c3_Vq = c3_y1;
        } else {
...
static void c3_b_eml_error(SFc3_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  const mxArray *c3_y = NULL;
  (void)chartInstance;
  for (c3_i15 = 0; c3_i15 < 35; c3_i15++) {
    c3_u[c3_i15] = c3_cv1[c3_i15];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 10, 0U, 1U, 0U, 2, 1, 35), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "error", 0U, 1U, 14,
                    sf_mex_call_debug(sfGlobalDebugInstanceStruct, "message", 1U,
    1U, 14, c3_y));
}
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_ballTossController), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_ballTossController);
  return c3_y;
}
...
void sf_c3_ballTossController_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_ballTossController_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_ballTossController_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_ballTossController_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_ballTossController(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"dref_cur\",},{M[1],M[5],T\"ref_cur\",},{M[8],M[0],T\"is_active_c3_ballTossController\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_ballTossController_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_ballTossControllerInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c3_t_ref)[10];
          c3_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c3_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c3_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c3_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 2);
          c3_dtraj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
          c3_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c3_traj_in);
          _SFD_SET_DATA_VALUE_PTR(1U, *c3_dtraj_in);
          _SFD_SET_DATA_VALUE_PTR(2U, *c3_t_ref);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_ref_cur);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_t_in);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_dref_cur);
        }
      }
    } else {
...
static void sf_opaque_initialize_c3_ballTossController(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
  initialize_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_ballTossController(void *chartInstanceVar)
{
  enable_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_ballTossController(void *chartInstanceVar)
{
  disable_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_ballTossController(void *chartInstanceVar)
{
  sf_gateway_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_ballTossController(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_ballTossController
    ((SFc3_ballTossControllerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_ballTossController();/* state var info */
...
extern void sf_internal_set_sim_state_c3_ballTossController(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_ballTossController();/* state var info */
  ...
  set_sim_state_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_ballTossController(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_ballTossController(S);
}

static void sf_opaque_set_sim_state_c3_ballTossController(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_ballTossController(S, st);
}

static void sf_opaque_terminate_c3_ballTossController(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_ballTossControllerInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_ballTossController((SFc3_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_ballTossController(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_ballTossController
      ((SFc3_ballTossControllerInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_ballTossController(SimStruct *S)
{
  SFc3_ballTossControllerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_ballTossControllerInstanceStruct *)utMalloc(sizeof
    (SFc3_ballTossControllerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_ballTossControllerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_ballTossController;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_ballTossController;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_ballTossController;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_ballTossController;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_ballTossController;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_ballTossController;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_ballTossController;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_ballTossController;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_ballTossController;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_ballTossController;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_ballTossController;
...
void c3_ballTossController_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_ballTossController(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_ballTossController(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_ballTossController(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_ballTossController_method_dispatcher.\n"
