...
set INCLUDE=c:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\ATLMFC\INCLUDE;c:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\INCLUDE;c:\Program Files (x86)\Microsoft SDKs\Windows\v7.0A\\include;C:\Program Files\MATLAB\R2014a\extern\include;%INCLUDE%
set LIB=c:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\ATLMFC\LIB\amd64;c:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\Lib\amd64;c:\Program Files (x86)\Microsoft SDKs\Windows\v7.0A\\Lib\X64;C:\Program Files\MATLAB\R2014a\lib\win64;C:\Program Files\MATLAB\R2014a\extern\lib\win64;;%LIB%
...
nmake -f ballTossController_sfun.mak
