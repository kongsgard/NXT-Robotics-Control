...
static const char * c4_debug_family_names[6] = { "nargin", "nargout", "traj_in",
  "t_ref", "t_in", "ref_cur" };

/* Function Declarations */
static void initialize_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static void initialize_params_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static void enable_c4_ballTossController(SFc4_ballTossControllerInstanceStruct
  *chartInstance);
static void disable_c4_ballTossController(SFc4_ballTossControllerInstanceStruct *
  chartInstance);
static void c4_update_debugger_state_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static void set_sim_state_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_ballTossController(SFc4_ballTossControllerInstanceStruct
  *chartInstance);
static void sf_gateway_c4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static void initSimStructsc4_ballTossController
  (SFc4_ballTossControllerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c4_ref_cur, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_ballTossControllerInstanceStruct
...
static real_T c4_interp1(SFc4_ballTossControllerInstanceStruct *chartInstance,
  real_T c4_varargin_1[10], real_T c4_varargin_2[10], real_T c4_varargin_3);
static void c4_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_b_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_eml_scalar_eg(SFc4_ballTossControllerInstanceStruct
  *chartInstance);
static void c4_c_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_d_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_StringToMethodID(SFc4_ballTossControllerInstanceStruct
  *chartInstance);
static void c4_e_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_f_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_g_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_h_assert(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_eml_error(SFc4_ballTossControllerInstanceStruct *chartInstance);
static void c4_b_eml_error(SFc4_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_ballTossController, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_ballTossControllerInstanceStruct
  *chartInstance);
  ...
  (SFc4_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_ballTossController = 0U;
}
  ...
  (SFc4_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T *c4_ref_cur;
  c4_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellmatrix(2, 1), false);
  c4_hoistedGlobal = *c4_ref_cur;
  c4_u = c4_hoistedGlobal;
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_ballTossController;
  ...
  (SFc4_ballTossControllerInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_ref_cur = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 0)), "ref_cur");
  chartInstance->c4_is_active_c4_ballTossController = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_ballTossController");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_ballTossController(chartInstance);
  ...
  (SFc4_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T c4_ref_cur;
  int32_T c4_i4;
  real_T c4_b_t_ref[10];
  int32_T c4_i5;
  real_T c4_b_traj_in[10];
  real_T *c4_b_ref_cur;
  real_T *c4_b_t_in;
  real_T (*c4_c_t_ref)[10];
  real_T (*c4_c_traj_in)[10];
  c4_b_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_c_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
  c4_c_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  for (c4_i0 = 0; c4_i0 < 10; c4_i0++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_traj_in)[c4_i0], 0U);
  }

  for (c4_i1 = 0; c4_i1 < 10; c4_i1++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_t_ref)[c4_i1], 1U);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_t_in;
  for (c4_i2 = 0; c4_i2 < 10; c4_i2++) {
    c4_traj_in[c4_i2] = (*c4_c_traj_in)[c4_i2];
  }

  for (c4_i3 = 0; c4_i3 < 10; c4_i3++) {
    c4_t_ref[c4_i3] = (*c4_c_t_ref)[c4_i3];
  }

  c4_t_in = c4_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_traj_in, 2U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_t_ref, 3U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_t_in, 4U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_ref_cur, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 2);
  if (CV_EML_IF(0, 1, 0, c4_t_in < 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 3);
    c4_ref_cur = 0.0;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 4);
    if (CV_EML_IF(0, 1, 1, c4_t_in > c4_t_ref[9])) {
      _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 5);
      c4_ref_cur = c4_traj_in[9];
    } else {
      _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 7);
      for (c4_i4 = 0; c4_i4 < 10; c4_i4++) {
        c4_b_t_ref[c4_i4] = c4_t_ref[c4_i4];
      }

      for (c4_i5 = 0; c4_i5 < 10; c4_i5++) {
        c4_b_traj_in[c4_i5] = c4_traj_in[c4_i5];
      }

      c4_ref_cur = c4_interp1(chartInstance, c4_b_t_ref, c4_b_traj_in, c4_t_in);
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -7);
  _SFD_SYMBOL_SCOPE_POP();
  *c4_b_ref_cur = c4_ref_cur;
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_ref_cur, 2U);
  _SFD_DATA_RANGE_CHECK(*c4_b_t_in, 3U);
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc4_ballTossControllerInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c4_ref_cur, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_ref_cur), &c4_thisId);
  sf_mex_destroy(&c4_ref_cur);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_ref_cur;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc4_ballTossControllerInstanceStruct *)chartInstanceVoid;
  c4_ref_cur = sf_mex_dup(c4_mxArrayInData);
  ...
  *c4_inData)
{
  ...
  for (c4_i6 = 0; c4_i6 < 10; c4_i6++) {
    c4_b_inData[c4_i6] = (*(real_T (*)[10])c4_inData)[c4_i6];
  }
...
const mxArray *sf_c4_ballTossController_get_eml_resolved_functions_info(void)
{
  const mxArray *c4_nameCaptureInfo = NULL;
  c4_nameCaptureInfo = NULL;
  sf_mex_assign(&c4_nameCaptureInfo, sf_mex_createstruct("structure", 2, 81, 1),
                false);
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("interp1"), "name", "name", 0);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1381882706U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("length"), "name", "name", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1311287716U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1378328384U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 15);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("strncmpi"), "name", "name", 15);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "resolved",
                  "resolved", 15);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1328890322U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("min"), "name", "name", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1311287718U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("lower"), "name", "name", 22);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 27);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("colon"), "name", "name", 27);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 28);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("colon"), "name", "name", 28);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 31);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 31);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmin"), "name", "name", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmin"), "name", "name", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmax"), "name", "name", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmax"), "name", "name", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "name", "name", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 52);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("coder.internal.nan"), "name",
                  "name", 52);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1362294432U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 53);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("coder.internal.prodsize"),
                  "name", "name", 53);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 53);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1360314988U), "fileTimeLo",
                  "fileTimeLo", 53);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 53);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 55);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("isnan"), "name", "name", 55);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 58);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("flip"), "name", "name", 58);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flip.m"), "resolved",
                  "resolved", 58);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1372614814U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flip.m"), "context",
                  "context", 60);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_assert_valid_dim"), "name",
                  "name", 60);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 60);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_dim.m"),
                  "context", "context", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("coder.internal.assertValidDim"),
                  "name", "name", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 63);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 63);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 63);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
...
static void c4_b_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmax"), "name", "name", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 67);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("isnan"), "name", "name", 67);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 67);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("coder.internal.bsearch"),
                  "name", "name", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1363743358U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 71);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 71);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 73);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmax"), "name", "name", 73);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 74);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mrdivide"), "name", "name", 74);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 76);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("rdivide"), "name", "name", 76);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 79);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_div"), "name", "name", 79);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  real_T c4_varargin_1[10], real_T c4_varargin_2[10], real_T c4_varargin_3)
{
  ...
  real_T c4_y2;
  int32_T exitg1;
  c4_assert(chartInstance);
  for (c4_i8 = 0; c4_i8 < 10; c4_i8++) {
    c4_y[c4_i8] = c4_varargin_2[c4_i8];
  }

  c4_xi = c4_varargin_3;
  for (c4_i9 = 0; c4_i9 < 10; c4_i9++) {
    c4_x[c4_i9] = c4_varargin_1[c4_i9];
  }

  c4_b_assert(chartInstance);
  c4_eml_scalar_eg(chartInstance);
  c4_c_assert(chartInstance);
  c4_d_assert(chartInstance);
  c4_StringToMethodID(chartInstance);
  c4_e_assert(chartInstance);
  c4_f_assert(chartInstance);
  c4_g_assert(chartInstance);
  c4_h_assert(chartInstance);
  c4_Vq = rtNaN;
  c4_k = 1;
  do {
    exitg1 = 0;
    if (c4_k < 11) {
      ...
      if (c4_x[1] < c4_x[0]) {
        for (c4_j1 = 1; c4_j1 < 6; c4_j1++) {
          c4_b_j1 = c4_j1;
          c4_xtmp = c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c4_b_j1), 1, 10, 1, 0) - 1];
          c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c4_b_j1), 1, 10, 1, 0) - 1] =
            c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c4_b_j1)), 1, 10, 1, 0) - 1];
          c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c4_b_j1)), 1, 10, 1, 0) - 1] = c4_xtmp;
        }

        for (c4_c_k = 1; c4_c_k < 6; c4_c_k++) {
          c4_d_k = c4_c_k;
          c4_tmp = c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c4_d_k), 1, 10, 1, 0) - 1];
          c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c4_d_k), 1, 10, 1, 0) - 1] =
            c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c4_d_k)), 1, 10, 1, 0) - 1];
          c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c4_d_k)), 1, 10, 1, 0) - 1] = c4_tmp;
        }
      }

      for (c4_e_k = 2; c4_e_k < 11; c4_e_k++) {
        c4_b_k = c4_e_k;
        if (c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c4_b_k), 1, 10, 1, 0) - 1] <=
            c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)(c4_b_k - 1)), 1, 10, 1, 0) - 1]) {
      ...
      if (c4_b_b) {
      } else if (c4_xik > c4_maxx) {
      } else if (c4_xik < c4_minx) {
      } else {
        c4_c_xi = c4_xik;
        c4_low_i = 1;
        c4_low_ip1 = 1;
        c4_high_i = 10;
        while (c4_high_i > c4_low_ip1 + 1) {
          c4_b_low_i = c4_low_i;
          c4_b_high_i = c4_high_i;
          c4_mid_i = (c4_b_low_i + c4_b_high_i) >> 1;
          if (c4_c_xi >= c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c4_mid_i), 1, 10, 1, 0) - 1]) {
            c4_low_i = c4_mid_i;
            c4_low_ip1 = c4_low_i;
          } else {
            c4_high_i = c4_mid_i;
        ...
        c4_n = c4_low_i;
        c4_xn = c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c4_n), 1, 10, 1, 0) - 1];
        c4_xnp1 = c4_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)(c4_n + 1)), 1, 10, 1, 0) - 1];
        c4_A = c4_xik - c4_xn;
        c4_B = c4_xnp1 - c4_xn;
        c4_d_x = c4_A;
        c4_b_y = c4_B;
        ...
        c4_r = c4_f_x / c4_d_y;
        c4_onemr = 1.0 - c4_r;
        c4_y1 = c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c4_n), 1, 10, 1, 0) - 1];
        c4_y2 = c4_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)(c4_n + 1)), 1, 10, 1, 0) - 1];
        if (c4_y1 == c4_y2) {
          c4_Vq = c4_y1;
        } else {
          c4_Vq = c4_onemr * c4_y1 + c4_r * c4_y2;
        }
      }
...
{
  int32_T c4_i10;
  static char_T c4_cv0[21] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'i', 'n', 't',
    'e', 'r', 'p', '1', ':', 'N', 'a', 'N', 'i', 'n', 'X' };
  ...
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 10, 0U, 1U, 0U, 2, 1, 21), false);
...
{
  int32_T c4_i11;
  static char_T c4_cv1[35] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o', 'l',
  ...
  const mxArray *c4_y = NULL;
  (void)chartInstance;
  for (c4_i11 = 0; c4_i11 < 35; c4_i11++) {
    c4_u[c4_i11] = c4_cv1[c4_i11];
  }

  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 10, 0U, 1U, 0U, 2, 1, 35), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "error", 0U, 1U, 14,
                    sf_mex_call_debug(sfGlobalDebugInstanceStruct, "message", 1U,
    1U, 14, c4_y));
}
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_ballTossController), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_ballTossController);
  return c4_y;
}
...
void sf_c4_ballTossController_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(152687774U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2569526679U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1660522834U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4134759334U);
}

mxArray *sf_c4_ballTossController_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("gHNHmycSREtu6ZvD2k2yn");
...
mxArray *sf_c4_ballTossController_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_ballTossController_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_ballTossController(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ref_cur\",},{M[8],M[0],T\"is_active_c4_ballTossController\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_ballTossController_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_ballTossControllerInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"t_ref");
          _SFD_SET_DATA_PROPS(2,2,0,1,"ref_cur");
          _SFD_SET_DATA_PROPS(3,1,1,0,"t_in");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,45,56,74,180);
        _SFD_CV_INIT_EML_IF(0,1,1,74,98,127,180);
...

        {
          ...
          real_T (*c4_traj_in)[10];
          real_T (*c4_t_ref)[10];
          c4_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c4_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c4_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
          c4_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c4_traj_in);
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_t_ref);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_ref_cur);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_t_in);
        }
      }
    } else {
...
{
  return "EBRemkVRpAl6dtZp68UA3E";
}

static void sf_opaque_initialize_c4_ballTossController(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
  initialize_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_ballTossController(void *chartInstanceVar)
{
  enable_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_ballTossController(void *chartInstanceVar)
{
  disable_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_ballTossController(void *chartInstanceVar)
{
  sf_gateway_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_ballTossController(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_ballTossController
    ((SFc4_ballTossControllerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_ballTossController();/* state var info */
...
extern void sf_internal_set_sim_state_c4_ballTossController(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_ballTossController();/* state var info */
  ...
  set_sim_state_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_ballTossController(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_ballTossController(S);
}

static void sf_opaque_set_sim_state_c4_ballTossController(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_ballTossController(S, st);
}

static void sf_opaque_terminate_c4_ballTossController(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ballTossControllerInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_ballTossController((SFc4_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_ballTossController(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_ballTossController
      ((SFc4_ballTossControllerInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3998228510U));
  ssSetChecksum1(S,(2408529600U));
  ssSetChecksum2(S,(2437376170U));
  ssSetChecksum3(S,(2457861201U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_ballTossController(SimStruct *S)
{
  SFc4_ballTossControllerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_ballTossControllerInstanceStruct *)utMalloc(sizeof
    (SFc4_ballTossControllerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_ballTossControllerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_ballTossController;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_ballTossController;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_ballTossController;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_ballTossController;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_ballTossController;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_ballTossController;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_ballTossController;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_ballTossController;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_ballTossController;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_ballTossController;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_ballTossController;
...
void c4_ballTossController_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_ballTossController(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_ballTossController(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_ballTossController(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_ballTossController_method_dispatcher.\n"
