...
MACHINE     = ballTossController
TARGET      = sfun
CHART_SRCS   = c1_ballTossController.c c3_ballTossController.c c4_ballTossController.c c5_ballTossController.c c6_ballTossController.c
MACHINE_SRC  = ballTossController_sfun.c
MACHINE_REG = ballTossController_sfun_registry.c
MAKEFILE    = ballTossController_sfun.mak
...
OBJLIST_FILE = ballTossController_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
LINK_MACHINE_LIBS = 
