...
static const char * c6_debug_family_names[8] = { "nargin", "nargout", "traj_in",
  "dtraj_in", "t_ref", "t_in", "ref_cur", "dref_cur" };

/* Function Declarations */
static void initialize_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static void initialize_params_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static void enable_c6_ballTossController(SFc6_ballTossControllerInstanceStruct
  *chartInstance);
static void disable_c6_ballTossController(SFc6_ballTossControllerInstanceStruct *
  chartInstance);
static void c6_update_debugger_state_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static void set_sim_state_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance, const mxArray *c6_st);
static void finalize_c6_ballTossController(SFc6_ballTossControllerInstanceStruct
  *chartInstance);
static void sf_gateway_c6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static void initSimStructsc6_ballTossController
  (SFc6_ballTossControllerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c6_dref_cur, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_ballTossControllerInstanceStruct
...
static real_T c6_interp1(SFc6_ballTossControllerInstanceStruct *chartInstance,
  real_T c6_varargin_1[10], real_T c6_varargin_2[10], real_T c6_varargin_3);
static void c6_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_b_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_eml_scalar_eg(SFc6_ballTossControllerInstanceStruct
  *chartInstance);
static void c6_c_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_d_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_StringToMethodID(SFc6_ballTossControllerInstanceStruct
  *chartInstance);
static void c6_e_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_f_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_g_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_h_assert(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_eml_error(SFc6_ballTossControllerInstanceStruct *chartInstance);
static void c6_b_eml_error(SFc6_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_ballTossController, const
  char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_ballTossControllerInstanceStruct
  *chartInstance);
  ...
  (SFc6_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_ballTossController = 0U;
}
  ...
  (SFc6_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T *c6_dref_cur;
  real_T *c6_ref_cur;
  c6_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_st = NULL;
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_createcellmatrix(3, 1), false);
  c6_hoistedGlobal = *c6_dref_cur;
  c6_u = c6_hoistedGlobal;
  c6_b_y = NULL;
  sf_mex_assign(&c6_b_y, sf_mex_create("y", &c6_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c6_y, 0, c6_b_y);
  c6_b_hoistedGlobal = *c6_ref_cur;
  c6_b_u = c6_b_hoistedGlobal;
  c6_c_y = NULL;
  sf_mex_assign(&c6_c_y, sf_mex_create("y", &c6_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c6_y, 1, c6_c_y);
  c6_c_hoistedGlobal = chartInstance->c6_is_active_c6_ballTossController;
  ...
  (SFc6_ballTossControllerInstanceStruct *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_dref_cur = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 0)), "dref_cur");
  *c6_ref_cur = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 1)), "ref_cur");
  chartInstance->c6_is_active_c6_ballTossController = c6_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
     "is_active_c6_ballTossController");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_ballTossController(chartInstance);
  ...
  (SFc6_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T c6_hoistedGlobal;
  int32_T c6_i3;
  real_T c6_traj_in[10];
  int32_T c6_i4;
  real_T c6_dtraj_in[10];
  int32_T c6_i5;
  real_T c6_t_ref[10];
  real_T c6_t_in;
  ...
  real_T c6_dref_cur;
  int32_T c6_i6;
  real_T c6_b_t_ref[10];
  int32_T c6_i7;
  real_T c6_b_traj_in[10];
  int32_T c6_i8;
  real_T c6_c_t_ref[10];
  int32_T c6_i9;
  real_T c6_b_dtraj_in[10];
  real_T *c6_b_ref_cur;
  real_T *c6_b_t_in;
  real_T *c6_b_dref_cur;
  real_T (*c6_d_t_ref)[10];
  real_T (*c6_c_dtraj_in)[10];
  real_T (*c6_c_traj_in)[10];
  c6_b_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_b_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_b_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c6_d_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 2);
  c6_c_dtraj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
  c6_c_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c6_sfEvent);
  for (c6_i0 = 0; c6_i0 < 10; c6_i0++) {
    _SFD_DATA_RANGE_CHECK((*c6_c_traj_in)[c6_i0], 0U);
  }

  for (c6_i1 = 0; c6_i1 < 10; c6_i1++) {
    _SFD_DATA_RANGE_CHECK((*c6_c_dtraj_in)[c6_i1], 1U);
  }

  for (c6_i2 = 0; c6_i2 < 10; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((*c6_d_t_ref)[c6_i2], 2U);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c6_sfEvent);
  c6_hoistedGlobal = *c6_b_t_in;
  for (c6_i3 = 0; c6_i3 < 10; c6_i3++) {
    c6_traj_in[c6_i3] = (*c6_c_traj_in)[c6_i3];
  }

  for (c6_i4 = 0; c6_i4 < 10; c6_i4++) {
    c6_dtraj_in[c6_i4] = (*c6_c_dtraj_in)[c6_i4];
  }

  for (c6_i5 = 0; c6_i5 < 10; c6_i5++) {
    c6_t_ref[c6_i5] = (*c6_d_t_ref)[c6_i5];
  }

  c6_t_in = c6_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 1U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_traj_in, 2U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_dtraj_in, 3U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_t_ref, 4U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_t_in, 5U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_ref_cur, 6U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_dref_cur, 7U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 2);
  if (CV_EML_IF(0, 1, 0, c6_t_in < 0.0)) {
    ...
    if (CV_EML_IF(0, 1, 1, c6_t_in > c6_t_ref[9])) {
      _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 6);
      c6_ref_cur = c6_traj_in[9];
      _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 7);
      c6_dref_cur = c6_dtraj_in[9];
    } else {
      _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 9);
      for (c6_i6 = 0; c6_i6 < 10; c6_i6++) {
        c6_b_t_ref[c6_i6] = c6_t_ref[c6_i6];
      }

      for (c6_i7 = 0; c6_i7 < 10; c6_i7++) {
        c6_b_traj_in[c6_i7] = c6_traj_in[c6_i7];
      }

      c6_ref_cur = c6_interp1(chartInstance, c6_b_t_ref, c6_b_traj_in, c6_t_in);
      _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 10);
      for (c6_i8 = 0; c6_i8 < 10; c6_i8++) {
        c6_c_t_ref[c6_i8] = c6_t_ref[c6_i8];
      }

      for (c6_i9 = 0; c6_i9 < 10; c6_i9++) {
        c6_b_dtraj_in[c6_i9] = c6_dtraj_in[c6_i9];
      }

      c6_dref_cur = c6_interp1(chartInstance, c6_c_t_ref, c6_b_dtraj_in, c6_t_in);
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -10);
  _SFD_SYMBOL_SCOPE_POP();
  *c6_b_ref_cur = c6_ref_cur;
  *c6_b_dref_cur = c6_dref_cur;
  ...
  _SFD_DATA_RANGE_CHECK(*c6_b_ref_cur, 3U);
  _SFD_DATA_RANGE_CHECK(*c6_b_t_in, 4U);
  _SFD_DATA_RANGE_CHECK(*c6_b_dref_cur, 5U);
}
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc6_ballTossControllerInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c6_dref_cur, const char_T *c6_identifier)
{
  ...
  c6_y = c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_dref_cur),
    &c6_thisId);
  sf_mex_destroy(&c6_dref_cur);
  return c6_y;
}
...
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  const mxArray *c6_dref_cur;
  const char_T *c6_identifier;
  emlrtMsgIdentifier c6_thisId;
  real_T c6_y;
  SFc6_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc6_ballTossControllerInstanceStruct *)chartInstanceVoid;
  c6_dref_cur = sf_mex_dup(c6_mxArrayInData);
  ...
  *c6_inData)
{
  ...
  chartInstance = (SFc6_ballTossControllerInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i10 = 0; c6_i10 < 10; c6_i10++) {
    c6_b_inData[c6_i10] = (*(real_T (*)[10])c6_inData)[c6_i10];
  }

  for (c6_i11 = 0; c6_i11 < 10; c6_i11++) {
...
const mxArray *sf_c6_ballTossController_get_eml_resolved_functions_info(void)
{
  const mxArray *c6_nameCaptureInfo = NULL;
  c6_nameCaptureInfo = NULL;
  sf_mex_assign(&c6_nameCaptureInfo, sf_mex_createstruct("structure", 2, 81, 1),
                false);
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("interp1"), "name", "name", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1381882706U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("length"), "name", "name", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("max"), "name", "name", 7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1311287716U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1378328384U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 15);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("strncmpi"), "name", "name", 15);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "resolved",
                  "resolved", 15);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1328890322U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 16);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_assert_supported_string"),
                  "name", "name", 16);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1327451510U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_assert_supported_string.m!inrange"),
                  "context", "context", 17);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_charmax"), "name", "name",
                  17);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 20);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("min"), "name", "name", 20);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1311287718U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("lower"), "name", "name", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/lower.m"), "context",
                  "context", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_string_transform"), "name",
                  "name", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("colon"), "name", "name", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 27);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1378328388U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 28);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("colon"), "name", "name", 28);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 31);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("floor"), "name", "name", 31);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmin"), "name", "name", 34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmin"), "name", "name", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!integer_colon_length_nonnegd"),
                  "context", "context", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 50);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 50);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "name", "name", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/char.m"), "resolved",
                  "resolved", 51);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1319762368U), "fileTimeLo",
                  "fileTimeLo", 51);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 51);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 52);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.nan"), "name",
                  "name", 52);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1362294432U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 53);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.prodsize"),
                  "name", "name", 53);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 53);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1360314988U), "fileTimeLo",
                  "fileTimeLo", 53);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 53);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 55);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("isnan"), "name", "name", 55);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 58);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("flip"), "name", "name", 58);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flip.m"), "resolved",
                  "resolved", 58);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1372614814U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flip.m"), "context",
                  "context", 60);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_assert_valid_dim"), "name",
                  "name", 60);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 60);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_dim.m"),
                  "context", "context", 61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.assertValidDim"),
                  "name", "name", 61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 63);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("floor"), "name", "name", 63);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 63);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
...
static void c6_b_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 67);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("isnan"), "name", "name", 67);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 67);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.bsearch"),
                  "name", "name", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 70);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.narginchk"),
                  "name", "name", 70);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363743358U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 71);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("floor"), "name", "name", 71);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 73);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 73);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 74);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mrdivide"), "name", "name", 74);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 76);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("rdivide"), "name", "name", 76);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 79);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_div"), "name", "name", 79);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  real_T c6_varargin_1[10], real_T c6_varargin_2[10], real_T c6_varargin_3)
{
  ...
  real_T c6_y2;
  int32_T exitg1;
  c6_assert(chartInstance);
  for (c6_i12 = 0; c6_i12 < 10; c6_i12++) {
    c6_y[c6_i12] = c6_varargin_2[c6_i12];
  }

  c6_xi = c6_varargin_3;
  for (c6_i13 = 0; c6_i13 < 10; c6_i13++) {
    c6_x[c6_i13] = c6_varargin_1[c6_i13];
  }

  c6_b_assert(chartInstance);
  c6_eml_scalar_eg(chartInstance);
  c6_c_assert(chartInstance);
  c6_d_assert(chartInstance);
  c6_StringToMethodID(chartInstance);
  c6_e_assert(chartInstance);
  c6_f_assert(chartInstance);
  c6_g_assert(chartInstance);
  c6_h_assert(chartInstance);
  c6_Vq = rtNaN;
  c6_k = 1;
  do {
    exitg1 = 0;
    if (c6_k < 11) {
      ...
      if (c6_x[1] < c6_x[0]) {
        for (c6_j1 = 1; c6_j1 < 6; c6_j1++) {
          c6_b_j1 = c6_j1;
          c6_xtmp = c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c6_b_j1), 1, 10, 1, 0) - 1];
          c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c6_b_j1), 1, 10, 1, 0) - 1] =
            c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c6_b_j1)), 1, 10, 1, 0) - 1];
          c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c6_b_j1)), 1, 10, 1, 0) - 1] = c6_xtmp;
        }

        for (c6_c_k = 1; c6_c_k < 6; c6_c_k++) {
          c6_d_k = c6_c_k;
          c6_tmp = c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c6_d_k), 1, 10, 1, 0) - 1];
          c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c6_d_k), 1, 10, 1, 0) - 1] =
            c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c6_d_k)), 1, 10, 1, 0) - 1];
          c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c6_d_k)), 1, 10, 1, 0) - 1] = c6_tmp;
        }
      }

      for (c6_e_k = 2; c6_e_k < 11; c6_e_k++) {
        c6_b_k = c6_e_k;
        if (c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c6_b_k), 1, 10, 1, 0) - 1] <=
            c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)(c6_b_k - 1)), 1, 10, 1, 0) - 1]) {
      ...
      if (c6_b_b) {
      } else if (c6_xik > c6_maxx) {
      } else if (c6_xik < c6_minx) {
      } else {
        c6_c_xi = c6_xik;
        c6_low_i = 1;
        c6_low_ip1 = 1;
        c6_high_i = 10;
        while (c6_high_i > c6_low_ip1 + 1) {
          c6_b_low_i = c6_low_i;
          c6_b_high_i = c6_high_i;
          c6_mid_i = (c6_b_low_i + c6_b_high_i) >> 1;
          if (c6_c_xi >= c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c6_mid_i), 1, 10, 1, 0) - 1]) {
            c6_low_i = c6_mid_i;
            c6_low_ip1 = c6_low_i;
          } else {
            c6_high_i = c6_mid_i;
        ...
        c6_n = c6_low_i;
        c6_xn = c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c6_n), 1, 10, 1, 0) - 1];
        c6_xnp1 = c6_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)(c6_n + 1)), 1, 10, 1, 0) - 1];
        c6_A = c6_xik - c6_xn;
        c6_B = c6_xnp1 - c6_xn;
        c6_d_x = c6_A;
        c6_b_y = c6_B;
        ...
        c6_r = c6_f_x / c6_d_y;
        c6_onemr = 1.0 - c6_r;
        c6_y1 = c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c6_n), 1, 10, 1, 0) - 1];
        c6_y2 = c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)(c6_n + 1)), 1, 10, 1, 0) - 1];
        if (c6_y1 == c6_y2) {
          c6_Vq = c6_y1;
        } else {
          c6_Vq = c6_onemr * c6_y1 + c6_r * c6_y2;
        }
      }
...
{
  int32_T c6_i14;
  static char_T c6_cv0[21] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'i', 'n', 't',
    'e', 'r', 'p', '1', ':', 'N', 'a', 'N', 'i', 'n', 'X' };
  ...
  for (c6_i14 = 0; c6_i14 < 21; c6_i14++) {
    c6_u[c6_i14] = c6_cv0[c6_i14];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 10, 0U, 1U, 0U, 2, 1, 21), false);
...
{
  int32_T c6_i15;
  static char_T c6_cv1[35] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o', 'l',
  ...
  const mxArray *c6_y = NULL;
  (void)chartInstance;
  for (c6_i15 = 0; c6_i15 < 35; c6_i15++) {
    c6_u[c6_i15] = c6_cv1[c6_i15];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 10, 0U, 1U, 0U, 2, 1, 35), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "error", 0U, 1U, 14,
                    sf_mex_call_debug(sfGlobalDebugInstanceStruct, "message", 1U,
    1U, 14, c6_y));
}
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_ballTossController), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_ballTossController);
  return c6_y;
}
...
void sf_c6_ballTossController_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4150500968U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2151359947U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(395328069U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1510542334U);
}

mxArray *sf_c6_ballTossController_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("rNxkHuQWHdjJ2FKEPEMdyB");
...
mxArray *sf_c6_ballTossController_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_ballTossController_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_ballTossController(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"dref_cur\",},{M[1],M[5],T\"ref_cur\",},{M[8],M[0],T\"is_active_c6_ballTossController\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_ballTossController_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_ballTossControllerInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"traj_in");
          _SFD_SET_DATA_PROPS(1,1,1,0,"dtraj_in");
          _SFD_SET_DATA_PROPS(2,1,1,0,"t_ref");
          _SFD_SET_DATA_PROPS(3,2,0,1,"ref_cur");
          _SFD_SET_DATA_PROPS(4,1,1,0,"t_in");
          _SFD_SET_DATA_PROPS(5,2,0,1,"dref_cur");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,67,78,114,297);
        _SFD_CV_INIT_EML_IF(0,1,1,114,138,197,297);
...

        {
          ...
          real_T (*c6_t_ref)[10];
          c6_dref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c6_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c6_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c6_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 2);
          c6_dtraj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
          c6_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c6_traj_in);
          _SFD_SET_DATA_VALUE_PTR(1U, *c6_dtraj_in);
          _SFD_SET_DATA_VALUE_PTR(2U, *c6_t_ref);
          _SFD_SET_DATA_VALUE_PTR(3U, c6_ref_cur);
          _SFD_SET_DATA_VALUE_PTR(4U, c6_t_in);
          _SFD_SET_DATA_VALUE_PTR(5U, c6_dref_cur);
        }
      }
    } else {
...
{
  return "mps77gaLLacodZnszQK4r";
}

static void sf_opaque_initialize_c6_ballTossController(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
  initialize_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_ballTossController(void *chartInstanceVar)
{
  enable_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_ballTossController(void *chartInstanceVar)
{
  disable_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_ballTossController(void *chartInstanceVar)
{
  sf_gateway_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_ballTossController(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_ballTossController
    ((SFc6_ballTossControllerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_ballTossController();/* state var info */
...
extern void sf_internal_set_sim_state_c6_ballTossController(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_ballTossController();/* state var info */
  ...
  set_sim_state_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_ballTossController(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_ballTossController(S);
}

static void sf_opaque_set_sim_state_c6_ballTossController(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_ballTossController(S, st);
}

static void sf_opaque_terminate_c6_ballTossController(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_ballTossControllerInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_ballTossController((SFc6_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_ballTossController(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_ballTossController
      ((SFc6_ballTossControllerInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4069574216U));
  ssSetChecksum1(S,(3338445092U));
  ssSetChecksum2(S,(322179234U));
  ssSetChecksum3(S,(2373749580U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_ballTossController(SimStruct *S)
{
  SFc6_ballTossControllerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_ballTossControllerInstanceStruct *)utMalloc(sizeof
    (SFc6_ballTossControllerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_ballTossControllerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_ballTossController;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_ballTossController;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_ballTossController;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_ballTossController;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_ballTossController;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_ballTossController;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_ballTossController;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_ballTossController;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_ballTossController;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_ballTossController;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_ballTossController;
...
void c6_ballTossController_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_ballTossController(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_ballTossController(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_ballTossController(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_ballTossController_method_dispatcher.\n"
