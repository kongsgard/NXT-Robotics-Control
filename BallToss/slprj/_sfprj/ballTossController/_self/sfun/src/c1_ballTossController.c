...
static const char * c1_debug_family_names[6] = { "nargin", "nargout", "traj_in",
  "t_ref", "t_in", "ref_cur" };

/* Function Declarations */
static void initialize_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static void initialize_params_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static void enable_c1_ballTossController(SFc1_ballTossControllerInstanceStruct
  *chartInstance);
static void disable_c1_ballTossController(SFc1_ballTossControllerInstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static void set_sim_state_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_ballTossController(SFc1_ballTossControllerInstanceStruct
  *chartInstance);
static void sf_gateway_c1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static void initSimStructsc1_ballTossController
  (SFc1_ballTossControllerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c1_ref_cur, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_ballTossControllerInstanceStruct
...
static real_T c1_interp1(SFc1_ballTossControllerInstanceStruct *chartInstance,
  real_T c1_varargin_1[10], real_T c1_varargin_2[10], real_T c1_varargin_3);
static void c1_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_b_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_ballTossControllerInstanceStruct
  *chartInstance);
static void c1_c_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_d_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_StringToMethodID(SFc1_ballTossControllerInstanceStruct
  *chartInstance);
static void c1_e_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_f_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_g_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_h_assert(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_ballTossControllerInstanceStruct *chartInstance);
static void c1_b_eml_error(SFc1_ballTossControllerInstanceStruct *chartInstance);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ballTossController, const
  char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ballTossControllerInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ballTossControllerInstanceStruct
  *chartInstance);
  ...
  (SFc1_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ballTossController = 0U;
}
  ...
  (SFc1_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T *c1_ref_cur;
  c1_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellmatrix(2, 1), false);
  c1_hoistedGlobal = *c1_ref_cur;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_ballTossController;
  ...
  (SFc1_ballTossControllerInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_ref_cur = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 0)), "ref_cur");
  chartInstance->c1_is_active_c1_ballTossController = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_ballTossController");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ballTossController(chartInstance);
  ...
  (SFc1_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  real_T c1_ref_cur;
  int32_T c1_i4;
  real_T c1_b_t_ref[10];
  int32_T c1_i5;
  real_T c1_b_traj_in[10];
  real_T *c1_b_ref_cur;
  real_T *c1_b_t_in;
  real_T (*c1_c_t_ref)[10];
  real_T (*c1_c_traj_in)[10];
  c1_b_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_c_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
  c1_c_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  for (c1_i0 = 0; c1_i0 < 10; c1_i0++) {
    _SFD_DATA_RANGE_CHECK((*c1_c_traj_in)[c1_i0], 0U);
  }

  for (c1_i1 = 0; c1_i1 < 10; c1_i1++) {
    _SFD_DATA_RANGE_CHECK((*c1_c_t_ref)[c1_i1], 1U);
  }
  ...
  for (c1_i2 = 0; c1_i2 < 10; c1_i2++) {
    c1_traj_in[c1_i2] = (*c1_c_traj_in)[c1_i2];
  }

  for (c1_i3 = 0; c1_i3 < 10; c1_i3++) {
    c1_t_ref[c1_i3] = (*c1_c_t_ref)[c1_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 1U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_traj_in, 2U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_t_ref, 3U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_t_in, 4U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_ref_cur, 5U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 2);
  if (CV_EML_IF(0, 1, 0, c1_t_in < 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 3);
    c1_ref_cur = 0.0;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 4);
    if (CV_EML_IF(0, 1, 1, c1_t_in > c1_t_ref[9])) {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 5);
      c1_ref_cur = c1_traj_in[9];
    } else {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 7);
      for (c1_i4 = 0; c1_i4 < 10; c1_i4++) {
        c1_b_t_ref[c1_i4] = c1_t_ref[c1_i4];
      }

      for (c1_i5 = 0; c1_i5 < 10; c1_i5++) {
        c1_b_traj_in[c1_i5] = c1_traj_in[c1_i5];
      }

      c1_ref_cur = c1_interp1(chartInstance, c1_b_t_ref, c1_b_traj_in, c1_t_in);
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -7);
  _SFD_SYMBOL_SCOPE_POP();
  *c1_b_ref_cur = c1_ref_cur;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ballTossControllerMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c1_b_ref_cur, 2U);
  _SFD_DATA_RANGE_CHECK(*c1_b_t_in, 3U);
}
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc1_ballTossControllerInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c1_ref_cur, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_ref_cur), &c1_thisId);
  sf_mex_destroy(&c1_ref_cur);
  return c1_y;
}
...
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_ref_cur;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  real_T c1_y;
  SFc1_ballTossControllerInstanceStruct *chartInstance;
  chartInstance = (SFc1_ballTossControllerInstanceStruct *)chartInstanceVoid;
  c1_ref_cur = sf_mex_dup(c1_mxArrayInData);
  ...
  *c1_inData)
{
  ...
  for (c1_i6 = 0; c1_i6 < 10; c1_i6++) {
    c1_b_inData[c1_i6] = (*(real_T (*)[10])c1_inData)[c1_i6];
  }
...
const mxArray *sf_c1_ballTossController_get_eml_resolved_functions_info(void)
{
  const mxArray *c1_nameCaptureInfo = NULL;
  c1_nameCaptureInfo = NULL;
  sf_mex_assign(&c1_nameCaptureInfo, sf_mex_createstruct("structure", 2, 81, 1),
                false);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("interp1"), "name", "name", 0);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1381882706U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("length"), "name", "name", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1311287716U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1378328384U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("strncmpi"), "name", "name", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "resolved",
                  "resolved", 15);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1328890322U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1311287718U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("lower"), "name", "name", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 27);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("colon"), "name", "name", 27);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 28);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("colon"), "name", "name", 28);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("floor"), "name", "name", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "name", "name", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1362294432U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 53);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("coder.internal.prodsize"),
                  "name", "name", 53);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 53);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1360314988U), "fileTimeLo",
                  "fileTimeLo", 53);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 53);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isnan"), "name", "name", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("flip"), "name", "name", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/flip.m"), "resolved",
                  "resolved", 58);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1372614814U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_dim.m"),
                  "context", "context", 61);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("coder.internal.assertValidDim"),
                  "name", "name", 61);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 63);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("floor"), "name", "name", 63);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 63);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
...
static void c1_b_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 64);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmax"), "name", "name", 64);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("coder.internal.bsearch"),
                  "name", "name", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1363743358U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmax"), "name", "name", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 74);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mrdivide"), "name", "name", 74);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("rdivide"), "name", "name", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  real_T c1_varargin_1[10], real_T c1_varargin_2[10], real_T c1_varargin_3)
{
  ...
  real_T c1_y2;
  int32_T exitg1;
  c1_assert(chartInstance);
  for (c1_i8 = 0; c1_i8 < 10; c1_i8++) {
    c1_y[c1_i8] = c1_varargin_2[c1_i8];
  }

  c1_xi = c1_varargin_3;
  for (c1_i9 = 0; c1_i9 < 10; c1_i9++) {
    c1_x[c1_i9] = c1_varargin_1[c1_i9];
  }

  c1_b_assert(chartInstance);
  c1_eml_scalar_eg(chartInstance);
  c1_c_assert(chartInstance);
  c1_d_assert(chartInstance);
  c1_StringToMethodID(chartInstance);
  c1_e_assert(chartInstance);
  c1_f_assert(chartInstance);
  c1_g_assert(chartInstance);
  c1_h_assert(chartInstance);
  c1_Vq = rtNaN;
  c1_k = 1;
  do {
    exitg1 = 0;
    if (c1_k < 11) {
      ...
      if (c1_x[1] < c1_x[0]) {
        for (c1_j1 = 1; c1_j1 < 6; c1_j1++) {
          c1_b_j1 = c1_j1;
          c1_xtmp = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c1_b_j1), 1, 10, 1, 0) - 1];
          c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_b_j1), 1, 10, 1, 0) - 1] =
            c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c1_b_j1)), 1, 10, 1, 0) - 1];
          c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c1_b_j1)), 1, 10, 1, 0) - 1] = c1_xtmp;
        }

        for (c1_c_k = 1; c1_c_k < 6; c1_c_k++) {
          c1_d_k = c1_c_k;
          c1_tmp = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", (real_T)c1_d_k), 1, 10, 1, 0) - 1];
          c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_d_k), 1, 10, 1, 0) - 1] =
            c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c1_d_k)), 1, 10, 1, 0) - 1];
          c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)(11 - c1_d_k)), 1, 10, 1, 0) - 1] = c1_tmp;
        }
      }

      for (c1_e_k = 2; c1_e_k < 11; c1_e_k++) {
        c1_b_k = c1_e_k;
        if (c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c1_b_k), 1, 10, 1, 0) - 1] <=
            c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)(c1_b_k - 1)), 1, 10, 1, 0) - 1]) {
      ...
      if (c1_b_b) {
      } else if (c1_xik > c1_maxx) {
      } else if (c1_xik < c1_minx) {
      } else {
        c1_c_xi = c1_xik;
        c1_low_i = 1;
        c1_low_ip1 = 1;
        ...
        while (c1_high_i > c1_low_ip1 + 1) {
          ...
          if (c1_c_xi >= c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", (real_T)c1_mid_i), 1, 10, 1, 0) - 1]) {
            c1_low_i = c1_mid_i;
            c1_low_ip1 = c1_low_i;
          } else {
            c1_high_i = c1_mid_i;
        ...
        c1_xn = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c1_n), 1, 10, 1, 0) - 1];
        c1_xnp1 = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)(c1_n + 1)), 1, 10, 1, 0) - 1];
        c1_A = c1_xik - c1_xn;
        c1_B = c1_xnp1 - c1_xn;
        c1_d_x = c1_A;
        c1_b_y = c1_B;
        ...
        c1_r = c1_f_x / c1_d_y;
        c1_onemr = 1.0 - c1_r;
        c1_y1 = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c1_n), 1, 10, 1, 0) - 1];
        c1_y2 = c1_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)(c1_n + 1)), 1, 10, 1, 0) - 1];
        if (c1_y1 == c1_y2) {
          c1_Vq = c1_y1;
        } else {
...
static void c1_b_eml_error(SFc1_ballTossControllerInstanceStruct *chartInstance)
{
  ...
  const mxArray *c1_y = NULL;
  (void)chartInstance;
  for (c1_i11 = 0; c1_i11 < 35; c1_i11++) {
    c1_u[c1_i11] = c1_cv1[c1_i11];
  }
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ballTossController), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ballTossController);
  return c1_y;
}
...
void sf_c1_ballTossController_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_ballTossController_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_ballTossController_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_ballTossController_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_ballTossController(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ref_cur\",},{M[8],M[0],T\"is_active_c1_ballTossController\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ballTossController_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_ballTossControllerInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c1_traj_in)[10];
          real_T (*c1_t_ref)[10];
          c1_t_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c1_ref_cur = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_t_ref = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 1);
          c1_traj_in = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c1_traj_in);
          _SFD_SET_DATA_VALUE_PTR(1U, *c1_t_ref);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_ref_cur);
          _SFD_SET_DATA_VALUE_PTR(3U, c1_t_in);
        }
      }
    } else {
...
static void sf_opaque_initialize_c1_ballTossController(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_ballTossController(void *chartInstanceVar)
{
  enable_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_ballTossController(void *chartInstanceVar)
{
  disable_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_ballTossController(void *chartInstanceVar)
{
  sf_gateway_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ballTossController(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ballTossController
    ((SFc1_ballTossControllerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ballTossController();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ballTossController(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_ballTossController();/* state var info */
  ...
  set_sim_state_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ballTossController(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ballTossController(S);
}

static void sf_opaque_set_sim_state_c1_ballTossController(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_ballTossController(S, st);
}

static void sf_opaque_terminate_c1_ballTossController(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ballTossControllerInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_ballTossController((SFc1_ballTossControllerInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ballTossController(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_ballTossController
      ((SFc1_ballTossControllerInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_ballTossController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ballTossController(SimStruct *S)
{
  SFc1_ballTossControllerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_ballTossControllerInstanceStruct *)utMalloc(sizeof
    (SFc1_ballTossControllerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ballTossControllerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_ballTossController;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_ballTossController;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_ballTossController;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ballTossController;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_ballTossController;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_ballTossController;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_ballTossController;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_ballTossController;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ballTossController;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ballTossController;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_ballTossController;
...
void c1_ballTossController_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ballTossController(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ballTossController(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ballTossController(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ballTossController_method_dispatcher.\n"
